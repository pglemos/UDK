...
const statusLabels: Record<string, string> = {
  ...
  failed: "Falhou",
  filed: "Protocolado",
  forwarded_email: "E-mail encaminhado",
  forming: "Em formação",
  granted: "Concedido",
  ...
  invited: "Convidado",
  judgment: "Julgamento",
  lead_campaign: "Campanha de captação",
  live: "Ao vivo",
  low: "Baixa",
  maintain: "Manter",
  manual_csv: "CSV manual",
  manual_pdf: "PDF manual",
  manager: "Gestor",
  medium: "Média",
...
export const moduleConfigs: ModuleConfig[] = [
  {
    key: "pilotos",
    label: "Pilotos",
    description: "Cadastro completo do piloto, foto, segurança, saúde e homologação.",
    table: "drivers",
    singular: "piloto",
    ...
    fields: [
      relation("season_id", "Temporada", "seasons", "name"),
      {
        ...
        relation: {
          table: "categories",
          labelColumn: "name",
          dependsOn: { field: "season_id", column: "season_id" },
        },
      },
      {
        key: "full_name",
      ...
      { key: "whatsapp", label: "WhatsApp", kind: "text", placeholder: "(21) 99999-9999" },
      { key: "cpf", label: "CPF", kind: "text", placeholder: "000.000.000-00" },
      { key: "birth_date", label: "Data de nascimento", kind: "date" },
      { key: "age", label: "Idade", kind: "number", placeholder: "Ex.: 34" },
      { key: "email", label: "E-mail", kind: "text", placeholder: "piloto@email.com" },
      { key: "city", label: "Cidade", kind: "text", placeholder: "Belo Horizonte" },
      { key: "state", label: "Estado (UF)", kind: "select" },
      {
        key: "weight_kg",
        label: "Peso com equipamento (kg)",
        kind: "number",
        placeholder: "Ex.: 92",
      },
      { key: "height_cm", label: "Altura (cm)", kind: "number", placeholder: "Ex.: 178" },
      { key: "gender", label: "Sexo", kind: "select" },
      {
        key: "avatar_url",
      ...
      },
      {
        ...
        kind: "textarea",
        placeholder:
          "Ex.: necessidade de orientação especial, restrição de agenda, observação para briefing ou nenhuma.",
      },
      {
        key: "status",
        label: "Situação",
      ...
      {
        key: "contact_authorized",
        label: "Autorização de contato",
        kind: "checkbox",
        required: true,
      },
      {
        key: "regulation_acknowledged",
        label: "Regulamento lido",
        kind: "checkbox",
        required: true,
      },
      {
        key: "participation_acknowledged",
        label: "Condições da participação",
        kind: "checkbox",
        required: true,
      },
      {
        key: "image_authorized",
  ...
  },
  {
    ...
    description:
      "Classificação de cada piloto na sessão: posição, voltas, tempo, pole e volta mais rápida.",
    ...
    fields: [
      ...
      { key: "pole", label: "Largada na pole", kind: "checkbox" },
  ...
  },
  {
    ...
    description: "Equipes, categoria, identificação e homologação.",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "relationship", label: "Parentesco / vínculo", kind: "text", required: true },
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("pending", "approved", "rejected", "revoked"),
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "required", label: "Obrigatório", kind: "checkbox" },
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("draft", "review", "published", "superseded", "archived"),
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "points_policy",
        label: "Política de pontos",
        kind: "select",
        required: true,
        options: statusOptions("transfer", "zero", "convert", "maintain"),
      },
  ...
  },
  {
    key: "sessoes",
    label: "Sessões",
    description: "Treinos, classificação, pole especial, corrida e resistência.",
    table: "sessions",
    singular: "sessão",
    titleColumn: "name",
    orderBy: "starts_at",
    fields: [
      ...
      { key: "name", label: "Nome", kind: "text", required: true },
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("practice", "qualifying", "super_pole", "race", "endurance"),
      },
  ...
  },
  {
    ...
    fields: [
      ...
      relation("driver_id", "Piloto", "drivers", "sport_name"),
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("expected", "present", "late", "absent", "excused", "blocked"),
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        ...relation("driver_id", "Piloto", "drivers", "sport_name", false),
        exclusiveWith: ["team_id"],
      },
      {
        ...relation("team_id", "Equipe", "endurance_teams", "name", false),
        exclusiveWith: ["driver_id"],
      },
      { key: "kart_number", label: "Número do kart", kind: "number", required: true },
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("assigned", "confirmed", "changed", "returned", "cancelled"),
      },
      { key: "notes", label: "Observações", kind: "textarea" },
    ],
  },
  ...
  },
  {
    ...
    fields: [
      relation("incident_id", "Ocorrência", "incidents", "incident_type"),
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("photo", "video", "report", "witness", "document", "timing"),
      },
      {
        key: "file_path",
        label: "Arquivo",
        kind: "file",
        storageBucket: "disciplinary-evidence",
      ...
      { key: "statement", label: "Relato", kind: "textarea" },
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("private", "involved", "committee", "public", "restricted"),
      },
      { key: "content_hash", label: "Hash", kind: "text" },
    ],
  },
  {
    ...
    fields: [
      ...
      relation("driver_id", "Piloto", "drivers", "sport_name"),
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("captain", "starter", "reserve"),
      },
      {
        key: "status",
        label: "Situação",
        kind: "select",
        required: true,
        options: statusOptions("invited", "accepted", "declined", "approved"),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "content", label: "Conteúdo", kind: "json", required: true },
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("draft", "review", "approved", "published", "archived"),
      },
  ...
  },
  {
    ...
    fields: [
      ...
      relation("user_id", "Usuário", "profiles", "full_name"),
      {
        ...
        kind: "select",
        required: true,
        options: statusOptions("owner", "manager", "analyst", "viewer"),
      },
      {
        key: "status",
        label: "Situação",
        kind: "select",
        required: true,
        options: statusOptions("invited", "active", "suspended", "revoked"),
      },
    ],
  },
  {
