...
export const premiumVisuals = {
  ...
  community: {
    src: "https://images.unsplash.com/photo-1649095381023-48ee8e4a8aba?auto=format&fit=crop&fm=webp&q=82&w=2400",
    alt: "Competidores de kart compartilhando o ambiente de pista",
    position: "50% 48%",
  },
  news: {
    src: "https://images.unsplash.com/photo-1774071900500-2cf042f345e4?auto=format&fit=crop&fm=webp&q=82&w=2400",
  ...
  detail: {
    src: "https://images.unsplash.com/photo-1752348512364-fac974d4d5b0?auto=format&fit=crop&fm=webp&q=82&w=2400",
    alt: "Detalhe de um kart esportivo no circuito",
    position: "50% center",
  },
